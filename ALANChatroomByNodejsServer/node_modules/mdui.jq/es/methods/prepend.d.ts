...
declare module '../JQ' {
    ...
    ```
         */
        prepend(...contents: Array<HTMLString | TypeOrArray<Node> | JQ<Node>>): this;
        /**
         * 在当前元素内部的前面插入指定内容
         * @param callback
    ...
    ```
         */
        prepend(callback: (this: T, index: number, html: string) => HTMLString | TypeOrArray<Node> | JQ<Node>): this;
    }
}
