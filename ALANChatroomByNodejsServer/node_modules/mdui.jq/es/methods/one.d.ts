...
declare module '../JQ' {
    interface JQ<T = HTMLElement> {
         ...
         */
        one(events: PlainObject<EventCallback | false>, selector: string | null | undefined, data?: any): this;
        /**
         ...
         */
        one(eventName: string, selector: string | null | undefined, data: any, callback: EventCallback | false): this;
        /**
         ...
         * @param callback 事件处理函数
         */
        one(eventName: string, selector: string, callback: EventCallback | false): this;
        /**
