...
declare module '../interfaces/JQStatic' {
    ...
    ```
         */
        extend<T extends PlainObject, U extends PlainObject, V extends PlainObject, W extends PlainObject, X extends PlainObject, Y extends PlainObject, Z extends PlainObject>(target: T, object1: U, object2: V, object3: W, object4: X, object5: Y, object6: Z): T & U & V & W & X & Y & Z;
        /**
         * 将所有对象的属性都添加到第一个对象，并返回合并后的对象。
         * @param target 其他参数的属性将合并到该参数
         * @param object1 该对象的属性将合并到第一个参数
    ...
    ```
         */
        extend<T extends PlainObject, U extends PlainObject, V extends PlainObject, W extends PlainObject, X extends PlainObject, Y extends PlainObject>(target: T, object1: U, object2: V, object3: W, object4: X, object5: Y): T & U & V & W & X & Y;
        /**
         * 将所有对象的属性都添加到第一个对象，并返回合并后的对象。
         * @param target 其他参数的属性将合并到该参数
         * @param object1 该对象的属性将合并到第一个参数
    ...
    ```
         */
        extend<T extends PlainObject, U extends PlainObject, V extends PlainObject, W extends PlainObject, X extends PlainObject>(target: T, object1: U, object2: V, object3: W, object4: X): T & U & V & W & X;
        /**
         * 将所有对象的属性都添加到第一个对象，并返回合并后的对象。
         * @param target 其他参数的属性将合并到该参数
         * @param object1 该对象的属性将合并到第一个参数
    ...
    ```
         */
        extend(target: PlainObject, object1: PlainObject, ...objectN: PlainObject[]): PlainObject;
    }
}
