...
declare module '../interfaces/JQStatic' {
    ...
    ```
         */
        each<T>(array: ArrayLike<T>, callback: (this: T, index: number, value: T) => any | false): ArrayLike<T>;
        /**
         * 遍历对象，原样返回第一个参数
         *
         * @param obj 需要遍历的对象
    ...
    ```
         */
        each<T extends PlainObject, K extends keyof T>(obj: T, callback: (this: T[K], key: K, value: T[K]) => any | false): T;
    }
}
